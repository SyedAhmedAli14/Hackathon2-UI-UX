        ...
        <div className='w-full h-[360px] flex flex-col relative group transition-all duration-200 hover:shadow-sm shadow-gray-300'>
            ...
            <div className='flex items-start justify-between gap-2 bg-white  py-5'>
                <div className={`"flex flex-col ${version == 2 ? 'items-end' : 'items-start'} gap-5"`}>
                    <Link href={"/product/1"}><h1 className={`text-navyBlue font-lato font-semibold ${version == 2 && 'text-lg'}`}>Ahmed Products</h1></Link>
                    <div className='flex justify-start items-center gap-2'>
                        <p className={`font-lato font-normal text-sm text-officeblue`}>$67.00</p>
                       {version == 2 && <p className={`font-lato font-normal text-sm text-red line-through`}>$56.00</p>}
