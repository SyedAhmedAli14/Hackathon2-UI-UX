...
const Datahandler = () => {
    return (
        ...
        <div className=' flex flex-col items-start justify-start'>
            <h2 className='text-2xl font-bold font-poppins text-officeblue'>Ecommerce Acceories & Fashion item</h2>
        ...
        <div className='flex items-center justify-start gap-2'>
            <label htmlFor="perpage" className='text-officeblue font-lato'>Per Page:</label>
        ...
        <div className='flex items-center justify-start gap-2'>
            <label htmlFor="perpage" className='text-officeblue font-lato font-medium'>Sort By: </label>
        ...
        <div className='flex items-center justify-start gap-2'>
            <label htmlFor="perpage" className='text-officeblue font-lato flex justify-start items-center gap-3'>View: <Link href={"/shop"}><IoGrid size={15} className='text-navyBlue' /></Link>
