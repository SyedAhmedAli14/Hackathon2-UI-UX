    ...
    return (
        <>
            ...
            <div className='flex flex-wrap justify-center items-center gap-6 py-2'>
                <p className='text-pinkcolor lato text-lg cursor-pointer'>Wood Chair</p>
            ...
            <div className='w-full h-auto lg:h-[570px] px-5 lg:px-40 py-10 flex flex-col-reverse gap-10 md:gap-0 md:flex-row justify-center items-center bg-white'>
                ...
                <div className='flex flex-col gap-5'>
                    <h2 className='text-4xl font-bold font-poppins text-navyBlue'>20% Discount Of All Products</h2>
                    <p className='text-xl text-pinkcolor font-semibold font-poppins'>Eams Sofa Compact</p>
                    ...
                    <div className='flex justify-start items-center gap-3'>
                        <button className='bg-pinkcolor text-white font-poppins font-semibold px-10 py-2 rounded-sm'>Shop Now</button>
                    </div>
                </div>
