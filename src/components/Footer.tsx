...
const Footer = () => {
    return (
        <>
        <div className='w-full h-auto px-5 lg:px-32 py-16 bg-skyBlue grid lg:grid-cols-5 md:grid-cols-2 gap-10'>
            <div className='flex flex-col gap-2 md:col-span-2'>
                ...
                <div className='grid grid-cols-6'>
                    ...
                    <button className='bg-pinkcolor text-white col-span-2 px-3 py-2 rounded-r-md'>Sign Up</button>
                </div>
            ...
            <div >
                <h6 className='text-xl font-semibold text-black font-poppins'>Categories</h6>
            ...
            <div >
                <h6 className='text-xl font-semibold text-black font-poppins'>Customer Care</h6>
                <ul className='flex flex-col gap-3 text-[#8A8FB9] py-4'>
                    <li>My Account</li>
                    <li>Discount</li>
                    <li>Returns</li>
            ...
            <div >
                <h6 className='text-xl font-semibold text-black font-poppins'>Pages</h6>
                <ul className='flex flex-col gap-3 text-[#8A8FB9] py-4'>
                    <li>Blog</li>
        ...
        <div className='px-5 lg:px-40 py-5 bg-skyBlue flex justify-between items-center'>
            <p className='text-[#8A8FB9]'>Syed Ahmed Ali Shah - All right reserved</p>
